...
int sensor[NUM_SENSORS] = {2, 3, A5, A4, A3, A2, A1}; //1, 2, 3, 4, 5, 6, 7 sensor pins
...
void loop() {
  ...
  int motorSpeed = 300 * sensorValues[0] + 200 * sensorValues[1] + 100 * sensorValues[2]
                   - 100 * sensorValues[5] - 200 * sensorValues[6];
